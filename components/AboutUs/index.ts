...
export { Detail_aboutUs } from '@/components/AboutUs/Detail_aboutUs/Detail_aboutUs';
export { ContactUs_aboutUs } from '@/components/AboutUs/ContactUs_aboutUs/ContactUs_aboutUs';
