...
export function Hero_claim_accident() {
  ...
  useEffect(() => {
    ...
    onGetSvg('/Claim/Accident/Hero_claim_accident.svg', setSvgSize);
    onGetSvg('/Claim/Accident/Hero_claim_accident_mobile.svg', setMobileSvgSize);
  }, []);
  ...
  const backgroundImage = isSmallScreen
    ? '/Claim/Accident/Hero_claim_accident_mobile.svg'
    : '/Claim/Accident/Hero_claim_accident.svg';
        ...
        >
          <Flex direction={'column'} h={'100%'} flex={isSmallScreen ? 1 : 1} justify={'center'}>
            ...
            >
              ...
              >
                <span style={{ color: '#1F9B90' }}>ประกัน</span>อุบัติเหตุ
              </Title>
            </Flex>
          </Flex>
