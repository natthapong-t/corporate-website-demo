...
export function Hero_claim_compulsory() {
  ...
  useEffect(() => {
    ...
    onGetSvg('/Claim/Compulsory/Hero_claim_compulsory.svg', setSvgSize);
    onGetSvg('/Claim/Compulsory/Hero_claim_compulsory_mobile.svg', setMobileSvgSize);
  }, []);
  ...
  const backgroundImage = isSmallScreen
    ? '/Claim/Compulsory/Hero_claim_compulsory_mobile.svg'
    : '/Claim/Compulsory/Hero_claim_compulsory.svg';
          ...
          <Flex direction={'column'} h={'100%'} flex={isSmallScreen ? 1 : 1} justify={'center'}>
            ...
            >
              ...
              <Title
                ...
                ta={isXSmallScreen ? 'center' : 'left'}
              >
                <span style={{ color: '#1F9B90' }}>ประกัน</span>รถยนต์ภาคสมัครใจ
              </Title>
            </Flex>
          </Flex>
