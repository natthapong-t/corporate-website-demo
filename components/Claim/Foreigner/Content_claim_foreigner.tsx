...
export function Content_claim_foreigner() {
      ...
      >
        ...
        >
          ...
          >
            ...
            <List withPadding w={'95%'}>
              <List.Item>
                ...
                <List w={'90%'}>
                  <List.Item>แบบฟอร์มการเรียกร้องสินไหมทดแทน</List.Item>
                  <List.Item>ใบเสร็จรับเงินต้นฉบับ และใบสรุปรายการค่ารักษาพยาบาล</List.Item>
                  <List.Item>ใบรับรองแพทย์ต้นฉบับ</List.Item>
                  <List.Item>
                    สำเนาหน้าพาสปอร์ต, แบบบัญชีรายชื่อแรงงานต่างด้าว ตามมติคณะรัฐมนตรี
                    (พร้อมรับรองสำเนาถูกต้อง)
                  </List.Item>
                  <List.Item>สำเนาใบรับรองการประกันภัย (พร้อมรับรองสำเนาถูกต้อง)</List.Item>
                  <List.Item>สำเนาหน้าบัญชีธนาคาร (พร้อมรับรองสำเนาถูกต้อง)</List.Item>
                </List>
              </List.Item>
              <List.Item>
                ...
                <List w={'90%'}>
                  <List.Item>แบบฟอร์มการเรียกร้องสินไหมทดแทน</List.Item>
                  <List.Item>ใบมรณบัตร</List.Item>
                  <List.Item>
                    สำเนารายงานชันสูตรพลิกศพ รับรองโดยร้อยเวรเจ้าของคดีหรือหน่วยงานที่ออกรายงาน
                  </List.Item>
                  <List.Item>สำเนาบันทึกประจำวันตำรวจ รับรองโดยร้อยเวรเจ้าของคดี</List.Item>
                  <List.Item>สำเนาทะเบียนบ้านประทับตรา “ตาย” (พร้อมรับรองสำเนาถูกต้อง)</List.Item>
                  <List.Item>
                    สำเนาหน้าพาสปอร์ต, แบบบัญชีรายชื่อแรงงานต่างด้าว ตามมติคณะรัฐมนตรี
                    (พร้อมรับรองสำเนาถูกต้อง)
                  </List.Item>
                  <List.Item>
                    สำเนาบัตรประจำตัวประชาชน หรือสำเนาหน้าพาสปอร์ตของผู้รับประโยชน์
                    (พร้อมรับรองสำเนาถูกต้อง)
                  </List.Item>
                  <List.Item>สำเนาใบรับรองการประกันภัย (พร้อมรับรองสำเนาถูกต้อง)</List.Item>
                  <List.Item>
              ...
              <List.Item>
                กรณีนายจ้าง/ บริษัทฯ เป็นผู้รับเงินค่าสินไหมทดแทน
                ต้องมีหนังสือโอนสิทธิเรียกร้องค่าสินไหมทดแทน
              </List.Item>
            </List>
          </Flex>
          ...
          >
            ...
            <Flex direction={isMediumScreen ? 'column' : 'row'} gap={'md'}>
              <Card
              ...
              >
                ...
                >
                  ...
                  >
                    หนังสือโอนสิทธิ์เรียกร้องค่าสินไหมทดแทน
                  </Text>
                </Flex>
