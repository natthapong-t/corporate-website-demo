...
export function Hero_claim_foreigner() {
  ...
  useEffect(() => {
    ...
    onGetSvg('/Claim/Foreigner/Hero_claim_foreigner.svg', setSvgSize);
    onGetSvg('/Claim/Foreigner/Hero_claim_foreigner_mobile.svg', setMobileSvgSize);
  }, []);
  ...
  const backgroundImage = isSmallScreen
    ? '/Claim/Foreigner/Hero_claim_foreigner_mobile.svg'
    : '/Claim/Foreigner/Hero_claim_foreigner.svg';
        ...
        >
          <Flex direction={'column'} h={'100%'} flex={isSmallScreen ? 1 : 1} justify={'center'}>
            ...
            >
              ...
              >
                <span style={{ color: '#1F9B90' }}>ประกัน</span>
                สุขภาพและอุบัติเหตุสำหรับแรงงานต่างชาติ
              </Title>
            </Flex>
          </Flex>
