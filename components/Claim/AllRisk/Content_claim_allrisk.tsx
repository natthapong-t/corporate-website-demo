...
export function Content_claim_allrisk() {
        ...
        >
          ...
          >
            ...
            <List withPadding w={'95%'}>
              ...
              <List.Item>รายงานการเกิดเหตุ</List.Item>
              <List.Item>รายการทรัพย์สินที่เสียหาย / สูญหาย</List.Item>
              <List.Item>ใบเสร็จรับเงิน ใบเสนอราคาค่าซ่อม / ค่าอะไหล่</List.Item>
              <List.Item>ภาพถ่ายความเสียหาย</List.Item>
              <List.Item>สำเนาบันทึกประจำวันเกี่ยวกับคดี</List.Item>
              <List.Item>
