...
export function Hero_claim_allrisk() {
  ...
  useEffect(() => {
    ...
    onGetSvg('/Claim/AllRisk/Hero_claim_allrisk.svg', setSvgSize);
    onGetSvg('/Claim/AllRisk/Hero_claim_allrisk_mobile.svg', setMobileSvgSize);
  }, []);
  ...
  const backgroundImage = isSmallScreen
    ? '/Claim/AllRisk/Hero_claim_allrisk_mobile.svg'
    : '/Claim/AllRisk/Hero_claim_allrisk.svg';
        ...
        >
          <Flex direction={'column'} h={'100%'} flex={isSmallScreen ? 1 : 1} justify={'center'}>
            ...
            >
              ...
              >
                <span style={{ color: '#1F9B90' }}>ประกัน</span>ความเสี่ยงภัยทุกชนิด
              </Title>
            </Flex>
          </Flex>
