...
export function Hero_claim_bike() {
  ...
  useEffect(() => {
    ...
    onGetSvg('/Claim/Bike/Hero_claim_bike.svg', setSvgSize);
    onGetSvg('/Claim/Bike/Hero_claim_bike_mobile.svg', setMobileSvgSize);
  }, []);
  ...
  const backgroundImage = isSmallScreen
    ? '/Claim/Bike/Hero_claim_bike_mobile.svg'
    : '/Claim/Bike/Hero_claim_bike.svg';
        ...
        >
          <Flex direction={'column'} h={'100%'} flex={isSmallScreen ? 1 : 1} justify={'center'}>
            ...
            >
              ...
              >
                <span style={{ color: '#1F9B90' }}>ประกัน</span>เช่าจักรยานยนต์
              </Title>
            </Flex>
          </Flex>
