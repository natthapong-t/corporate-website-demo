...
export function Hero_claim_travel() {
  ...
  useEffect(() => {
    ...
    onGetSvg('/Claim/Travel/Hero_claim_travel.svg', setSvgSize);
    onGetSvg('/Claim/Travel/Hero_claim_travel_mobile.svg', setMobileSvgSize);
  }, []);
  ...
  const backgroundImage = isSmallScreen
    ? '/Claim/Travel/Hero_claim_travel_mobile.svg'
    : '/Claim/Travel/Hero_claim_travel.svg';
        ...
        >
          <Flex direction={'column'} h={'100%'} flex={isSmallScreen ? 1 : 1} justify={'center'}>
            ...
            >
              ...
              >
                <span style={{ color: '#1F9B90' }}>ประกัน</span>การเดินทาง
              </Title>
            </Flex>
          </Flex>
