...
export function Hero_claim_voluntary() {
  ...
  useEffect(() => {
    ...
    onGetSvg('/Claim/Voluntary/Hero_claim_voluntary.svg', setSvgSize);
    onGetSvg('/Claim/Voluntary/Hero_claim_voluntary_mobile.svg', setMobileSvgSize);
  }, []);
  ...
  const backgroundImage = isSmallScreen
    ? '/Claim/Voluntary/Hero_claim_voluntary_mobile.svg'
    : '/Claim/Voluntary/Hero_claim_voluntary.svg';
