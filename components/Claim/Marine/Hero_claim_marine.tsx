...
export function Hero_claim_marine() {
  ...
  useEffect(() => {
    ...
    onGetSvg('/Claim/Marine/Hero_claim_marine.svg', setSvgSize);
    onGetSvg('/Claim/Marine/Hero_claim_marine_mobile.svg', setMobileSvgSize);
  }, []);
  ...
  const backgroundImage = isSmallScreen
    ? '/Claim/Marine/Hero_claim_marine_mobile.svg'
    : '/Claim/Marine/Hero_claim_marine.svg';
        ...
        >
          <Flex direction={'column'} h={'100%'} flex={isSmallScreen ? 1 : 1} justify={'center'}>
            ...
            >
              ...
              >
                <span style={{ color: '#1F9B90' }}>ประกัน</span>ทางทะเลและขนส่ง
              </Title>
            </Flex>
          </Flex>
